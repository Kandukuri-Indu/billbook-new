...
const QuotationDetails = () => {
  ...
  console.log("ivoice by id", quotationDetails);
  ...
  const addressLine1 =
    quotationDetails?.customerName?.billingAddress?.addressLine1;
  const addressLine2 =
    quotationDetails?.customerName?.billingAddress?.addressLine2;
  const city = quotationDetails?.customerName?.billingAddress?.city;
  const country = quotationDetails?.customerName?.billingAddress?.country;
  const name = quotationDetails?.customerName?.billingAddress?.name;
  const pincode = quotationDetails?.customerName?.billingAddress?.pincode;
  const state = quotationDetails?.customerName?.billingAddress?.state;
    ...
    const fetchQuotationDetails = async () => {
      try {
        const response = await axios.get(
          `http://localhost:8000/api/addQuotation/quotations/${id}`
        );
                        ...
                        <div className="card-body">
                          ...
                          <div className="invoice-item invoice-table-wrap">
                            ...
                            <div className="row">
                              <div className="col-md-12">
                                {quotationDetails && quotationDetails.table ? (
                              ...
                              <div className="col-lg-6 col-md-6">
                                ...
                                <div className="invoice-terms align-center">
                                  ...
                                  <div className="invocie-note">
                                    <h6>Note</h6>
                                    <p className="mb-0">
                                      {quotationDetails?.bankDetails?.notes}
                                    </p>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div className="invoice-total-box">
                                    <div className="invoice-total-inner">
                                      <p>
                                        Taxable Amount
                                        <span>
                                          {quotationDetails?.taxableAmount}
                                        </span>
                                      </p>
                                      <p>
                                        Total Discount (
                                        {
                                          quotationDetails?.totalDiscountPercentage
                                        }
                                        %)
                                        <span>
                                      ...
                                      <p>
                                        Total Tax (
                                        {quotationDetails.totalTaxPercentage}%){" "}
                                        <span>
                                          {quotationDetails.totalTax === 0
                                            ? "Tax Exemption"
                                            : quotationDetails.totalTax}
                                        </span>
                                      </p>
                                      {quotationDetails.totalTax !== 0 && (
                                        <>
                                          <p>
                                            CGST (
                                            {
                                              quotationDetails?.cgstTaxPercentage
                                            }
                                            %){" "}
                                            <span>
                                              {quotationDetails?.cgstTaxAmount ===
                                              0
                                                ? "Tax Exemption"
                                                : quotationDetails?.cgstTaxAmount}
                                            </span>
                                          ...
                                          <p>
                                            SGST (
                                            {
                                              quotationDetails?.sgstTaxPercentage
                                            }
                                            %){" "}
                                            <span>
                                              {quotationDetails?.sgstTaxAmount ===
                                              0
                                                ? "Tax Exemption"
                                                : quotationDetails?.sgstTaxAmount}
                                            </span>
                          ...
                          <div className="invoice-sign text-end">
                            <span className="d-block">
                              {quotationDetails?.bankDetails?.signatureName}
                            </span>
                            <img
