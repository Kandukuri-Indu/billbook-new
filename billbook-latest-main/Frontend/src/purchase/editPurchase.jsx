...
const EditPurchases = () => {
  ...
  const handlePaymentTermsChange = (terms) => {
    ...
    const totalDays = Math.ceil(
      (formData.dueDate.getTime() - formData.purchasesDate.getTime()) /
        (24 * 60 * 60 * 1000) +
        1
    );
    ...
    const fetchPurchaseeDetails = async (id) => {
      try {
        ...
        if (response.ok) {
          ...
          setFormData(purchaseDetails);
          console.log("Invoicedatagetting", purchaseDetails);
          console.log("GrandTotalForAll", purchaseDetails.grandTotal);
        } else {
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              value={
                                formData.purchaseNumber || getNextInvoiceNumber()
                              }
                              disabled
                              // onChange={(e) =>
                              //   handleInputChange(
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12">
                          <div className="form-group">
                            ...
                            <DatePicker
                                ...
                                selected={new Date(formData.purchasesDate)}
                                onChange={(date) =>
